...
$string['settingtodraftconfirm'] = '<p>You are about to create a new draft policy based on the inactive <em>\'{$a->name}\'</em> version <em>\'{$a->revision}\'</em>.</p><p>The policy will not apply until some version is made the current one.</p>';
