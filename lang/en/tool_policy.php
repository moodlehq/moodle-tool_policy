...
$string['versioncheck'] = 'Policies plugin version check';
$string['versioncheckerror'] = '<strong>Invalid plugin version!</strong> The Policies plugin was merged into the standard Moodle distribution in versions 3.3.8 and 3.4.5. You have it currently installed as an additional plugin. You must remove the additional plugin code and instead use the plugin code in Moodle core.';
$string['versioncheckwarning'] = '<strong>Warning!</strong> The Policies plugin was merged into the standard Moodle distribution in versions 3.3.8 and 3.4.5. You have it currently installed as an additional plugin. Make sure you remove the additional plugin code when upgrading your site, as it will be replaced with core code.';
