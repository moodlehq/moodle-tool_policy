...
$string['settingtodraft'] = 'Creating a draft policy';
$string['settingtodraftconfirm'] = '<p>You are about to create a new draft policy based on the inactive <em>\'{$a->name}\'</em> version <em>\'{$a->revision}\'</em>.</p><p>The draft policy will not apply until it is made active.</p>';
$string['settingtodraftconfirmyes'] = 'Create a new draft';
