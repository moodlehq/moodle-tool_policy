...
$string['nopermissiontoagreedocs_desc'] = 'Sorry, you do not have the required permissions to accept policies.<br />You will not be able to use this site until the following policies are agreed:';
$string['nopermissiontoagreedocsbehalf'] = 'No permission to accept policies on behalf of this user';
$string['nopermissiontoagreedocsbehalf_desc'] = 'Sorry, you do not have the required permission to accept the following policies on behalf of {$a}:';
...
$string['policydocs'] = 'Policies and agreements';
...
$string['privacyofficer_desc'] = 'Information and contact details of the privacy officer, such as the address, email and  phone number.';
